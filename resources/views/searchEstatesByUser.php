...
<div class="uk-card uk-card-default uk-card-body uk-margin-large-top">
    <ul class="uk-nav-default uk-nav-parent-icon" uk-nav>
        <li class="uk-parent">
            <a class="uk-heading-small">Advanced Search</a>
            <ul class="uk-nav-sub">
                <form action="" method="get" class=" uk-child-width-1-2@m uk-grid-large" uk-grid>
                    <div class="uk-child-width-1-2" uk-grid>
                        <div>
                            ...
                            <div class="uk-inline uk-width-1-1 uk-padding-small uk-padding-remove-horizontal">
                                <input class="uk-input uk-width-1-1" type="number" step="1" id="price-from-input"
                                       name="priceFrom"
                        ...
                        <div>
                            ...
                            <div class="uk-inline uk-width-1-1 uk-padding-small uk-padding-remove-horizontal">
                                <input class="uk-input uk-width-1-1" type="number" step="1" id="price-up-to-input"
                                       name="priceUpTo"
                    ...
                    <div class="uk-child-width-1-2 uk-margin-remove-top" uk-grid>
                        <div>
                            ...
                            <div class="uk-inline uk-width-1-1 uk-padding-small uk-padding-remove-horizontal">
                                <input class="uk-input uk-width-1-1" type="number" id="surface-from-input"
                                       name="surfaceFrom"
                        ...
                        <div>
                            ...
                            <div class="uk-inline uk-width-1-1 uk-padding-small uk-padding-remove-horizontal">
                                <input class="uk-input uk-width-1-1" type="number" step="1" id="surface-up-to-input"
                                       name="surfaceUpTo"
                    ...
                    <div class="uk-child-width-1-2" uk-grid>
                        <div>
                            ...
                            <div class="uk-inline uk-width-1-1 uk-padding-small uk-padding-remove-horizontal">
                                <input class="uk-input uk-width-1-1" type="number" step="1" id="rooms-from-input"
                                       name="roomsFrom"
                        ...
                        <div>
                            ...
                            <div class="uk-inline uk-width-1-1 uk-padding-small uk-padding-remove-horizontal">
                                <input class="uk-input uk-width-1-1" type="number" step="1" id="rooms-up-to-input"
                                       name="roomsUpTo"
                    ...
                    <div class="uk-child-width-1-2" uk-grid>
                        <div class="">
                            ...
                            <div class="uk-inline uk-width-1-1 uk-padding-small uk-padding-remove-horizontal">
                                <input class="uk-input uk-width-1-1" type="number" step="1" id="year-from-input"
                                       name="yearFrom"
                        ...
                        <div>
                            ...
                            <div class="uk-inline uk-width-1-1 uk-padding-small uk-padding-remove-horizontal">
                                <input class="uk-input uk-width-1-1" type="number" step="1" id="year-up-to-input"
                                       name="yearUpTo"
                    ...
                    <div class="uk-child-width-1-2" uk-grid>
                        <div class="">
                            ...
                            <div class="uk-inline uk-width-1-1 uk-padding-small uk-padding-remove-horizontal">
                                <input class="uk-input uk-width-1-1" type="number" step="1" id="floor-from-input"
                                       name="floorFrom"
                        ...
                        <div>
                            ...
                            <div class="uk-inline uk-width-1-1 uk-padding-small uk-padding-remove-horizontal">
                                <input class="uk-input uk-width-1-1" type="number" step="1" id="floor-up-to-input"
                                       name="floorUpTo"
                                ...
                                <select class="uk-select" name="cityId" id="location-input">
                                    ...
                                    <?php foreach ($cities as $city): ?>
                                        <option value="<?= $city->id ?>"
                                                onclick="populateMicroLocations('<?= $city->id ?>')"><?= $city->name ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
    ...
    <?php if (isset($paginatedResponse)): ?>
        <div class="uk-child-width-1-2@m uk-grid-small" uk-grid>
            <?php foreach ($paginatedResponse->data as $estate): ?>
                <?php include __DIR__ . '/../templates/estateSearchCardForUser.php' ?>
            <?php endforeach; ?>
        </div>
